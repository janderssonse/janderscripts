...
lint() {
  ...
  podman run --rm --volume "$(pwd)":/repo -e MEGALINTER_CONFIG='configs/mega-linter.yml' -e DEFAULT_WORKSPACE=${MEGALINTER_DEF_WORKSPACE} -e LOG_LEVEL=INFO oxsecurity/megalinter-java:v7.0.2
